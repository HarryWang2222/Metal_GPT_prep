...
with open('./data_2/mse content.txt', 'r',encoding='utf-8')as content_file:
    for content_line in content_file.readlines():
        ...
        with open('./mse_urls/{}.txt'.format(year), 'w', encoding='utf-8')as output:
            for i in range(start, end+1):
                with open('./urls/mse{}.txt'.format(i), 'rt',encoding='utf-8')as sigle_file:
