...
if __name__ == '__main__':
    ...
    for i in range(18,25):
        filepath = './data/acta{}.txt'.format(i)  # doi所在的原始 txt (由web-of-science 搜索结果导出的plain text file)
        savepath = './documents/acta{}'.format(i)
        sci_spider(filepath, dir=savepath, start_url=start_url, nolimit=True, cache=cache)
